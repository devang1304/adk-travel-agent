...
import asyncio
from google_adk import RuntimeConfig, RuntimeManager, AgentFactory
from google_adk.orchestrator import AgentOrchestrator
...
async def main():
    ...
    print("Travel Plan:")
    print(results["coordinator_agent"]["final_plan"])
